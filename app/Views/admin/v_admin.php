                    ...
                    <!-- Nama Band -->
                     <form method="POST" action="/admin/save" enctype="multipart/form-data">
                            ...
                            <div>
                                ...
                                <input type="file" name="gambar[]" multiple class="w-full px-3 py-2 border border-gray-300 rounded-lg bg-white">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="tag" placeholder="Masukkan tag (pisahkan dengan koma)"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400">
                            </div>
            ...
            <table class="min-w-full border border-gray-200 rounded-lg overflow-hidden">
                ...
                <tbody class="bg-white text-gray-700">
                    ...
                    <tr class="border-t hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3"><img src="/img_upload/<?= $higgle['thumbnail'] ?>" alt="<?= $higgle['nama_band'] ?>" class="w-16 h-16 object-cover"></td>
